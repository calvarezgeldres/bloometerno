-- ==============================================================================
-- SCHEMA SQL PARA BLOOM ETERNO (SUPABASE / POSTGRESQL)
-- ==============================================================================
-- Puedes copiar y pegar todo este script directamente en el "SQL Editor"
-- de tu proyecto en Supabase (https://supabase.com/dashboard).
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.store_settings (
    ...
    account_number VARCHAR(100) NOT NULL DEFAULT '12-34567-8',
    account_rut VARCHAR(20) NOT NULL DEFAULT '76.543.210-K',
...
INSERT INTO public.store_settings (id, bank_name, account_type, account_number, account_rut, account_holder, contact_email, whatsapp_number, free_shipping_threshold)
VALUES (
    'default',
    'Banco Santander',
    'Cuenta Corriente',
...
-- Políticas de lectura pública para la tienda
CREATE POLICY "Lectura pública de productos activos" 
    ON public.products FOR SELECT USING (true);

CREATE POLICY "Inserción pública de productos" 
    ON public.products FOR INSERT WITH CHECK (true);

CREATE POLICY "Actualización de stock y productos" 
    ON public.products FOR UPDATE USING (true);

CREATE POLICY "Eliminación de productos" 
...
CREATE POLICY "Actualización de estado de pedidos" 
    ON public.orders FOR UPDATE USING (true);

CREATE POLICY "Creación de ítems de pedido" 
    ON public.order_items FOR INSERT WITH CHECK (true);

CREATE POLICY "Lectura de ítems de pedido" 
    ON public.order_items FOR SELECT USING (true);

CREATE POLICY "Lectura de configuración de tienda" 
    ON public.store_settings FOR SELECT USING (true);

CREATE POLICY "Actualización de configuración" 
    ON public.store_settings FOR UPDATE USING (true);

-- 6. Habilitar Realtime para productos y pedidos
ALTER PUBLICATION supabase_realtime ADD TABLE public.products;
ALTER PUBLICATION supabase_realtime ADD TABLE public.orders;

-- 7. Catálogo Semilla Inicial (Seed Data)
INSERT INTO public.products (num, name, price, stock, category, badge, badge_type, image, alt)
VALUES 
